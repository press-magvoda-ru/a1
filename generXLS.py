...
#TODO до nxt 26Feb прикрутить в папку Hints cfg (ini скорее yaml файл с умолчальными настройками а пока ручками /"$/&ПА-ЧИН&ЛОГИСТ"/)
Urs = "ВОДОКАНАЛ&ТЕПЛОФИКАЦИЯ&МЭК&АЗИМУТ&ГКС МКД&МГС&КУИИЗО&ПА-ЧИН&ЛОГИСТ"
NeedWF = 0
OnlyTotals = 1
